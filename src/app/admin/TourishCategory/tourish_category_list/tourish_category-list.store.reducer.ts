...
export const reducer = createReducer(
  ...
  on(TourishCategoryListAction.deleteTourishCategory, (state, { payload }) => ({
    ...state,
  })),

  on(TourishCategoryListAction.deleteTourishCategorySuccess, (state, { response }) => ({
    ...state,
    deleteStatus: response,
  })),

  on(TourishCategoryListAction.deleteTourishCategoryFailed, (state, { response }) => ({
    ...state,
    messageCode: {code: response.messageCode},
  })),

  on(TourishCategoryListAction.deleteTourishCategorySystemFailed, (state, { error }) => ({
    ...state,
    error: {message: error},
  })),
